...
(function(wp, $) {
	const api = wp.customize
		...
		// 		let value = picker.wpColorPicker( 'color' );
		...
		// 		let $transparency = $container.find( '.transparency' );
	...
	api.controlConstructor['alpha-color'] = api.Control.extend(/** @lends wp.customize.ColorControl.prototype */{
		ready: function() {
			const control = this
			...
			picker.val( control.setting() ).wpColorPicker({
				change: function(event, ui) {
					...
					const transparency = control.container.find( '.transparency' );
					transparency.css( 'background-color', ui.color.toString( 'no-alpha' ) );
					updating = false;
				}
			});
